...
public class MainVentas extends javax.swing.JPanel {
    ...
    public MainVentas() {
        ...
        ProductoDaoI daoP = new ProductoDAO();
        ...
        txtCantidad.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                double valor = Double.parseDouble(txtCantidad.getText()) * Double.parseDouble(txtPUnit.getText());
                txtPtotal.setText("" + valor);
            }
        });
    ...
    public List<CarritoTO> listarCarrito(String dni) {
        ...
        TableColumn column = tablaDetalle.getColumnModel().getColumn(8);
        column.setCellRenderer(new ButtonsRenderer());
        ButtonsEditor be = new ButtonsEditor(tablaDetalle);
        ...
        btnDel.addActionListener((ActionEvent e) -> {
            ...
            int row
                    = tablaDetalle.convertRowIndexToModel(tablaDetalle.getEditingRow());
            Object o = tablaDetalle.getModel().getValueAt(row, 0);
            daoCa = new CarritoDao();
            try {
    ...
    private void initComponents() {
        ...
        txtDniAutoComp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtDniAutoCompActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtPUnit, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel8))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel9)
                    .addComponent(txtPtotal, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
        ...
        tablaDetalle.setBackground(new java.awt.Color(51, 255, 204));
        tablaDetalle.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        tablaDetalle.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DNI/RUC", "Id. Product", "Producto", "Cantidad", "P. Unitario S/.", "P. Total S/.", "Estado", "Opc"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        to.setDniruc(txtDniAutoComp.getText());
...
// System.out.println(x);
        if (pvc.capturarCliente() != null) {
            ...
            txtNombre.setText(tt.getNombrers());
            txtDniAutoComp.setText(tt.getDniruc());
        }

    }//GEN-LAST:event_jButton1ActionPerformed

    private void txtDniAutoCompActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDniAutoCompActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtDniAutoCompActionPerformed
